        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#it-solutions" className="hover:text-blue-500 transition-colors">
                  IT Solutions
                </Link>
              </li>
              <li>
                <Link href="#telecom-services" className="hover:text-blue-500 transition-colors">
                  Telecom Services
                </Link>
              </li>
              <li>
                <Link href="#ai-integration" className="hover:text-blue-500 transition-colors">
                  AI Integration
                </Link>
              </li>
              <li>
                <Link href="#consulting" className="hover:text-blue-500 transition-colors">
                  Consulting
                </Link>
              </li>
            </ul>
